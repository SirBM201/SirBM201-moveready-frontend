...
export const platformModules: PlatformModule[] = [
  ...
  },
  {
    ...
    readiness: "The verified in-app inbox matches watches to stored public opportunity records and links to official sources. External email, WhatsApp, Telegram, or phone delivery remains operationally gated.",
    launchScope: "Saved watches, current in-app alerts, source-review status, preferred channels, reminder types, and official-source handoff.",
    href: "/watchlist",
  },
  {
    slug: "passport-index",
  ...
  },
  {
    ...
    availability: "available",
    summary: "Assess academic fit, field change, language evidence, affordability, scholarship dependency, intake timing, family pressure, refusals, and regulated-career risk.",
    readiness: "The live planner creates programme-search strategy, application stages, evidence, funding-gap warnings, study-visa preparation, family tasks, and verified account storage without promising outcomes.",
    launchScope: "Academic profile, course strategy, institution checks, funding, scholarships, offers, study visa, dependants, regulated professions, and arrival preparation.",
    href: "/study-planner",
  },
  {

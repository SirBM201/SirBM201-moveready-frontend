...
export type JobLead = {
  ...
  international_recruitment_status?: string;
  relocation_support_status?: string;
  ...
  application_viability_score?: number;
  application_priority_score?: number;
...
export type JobAutomationAlert = {
  id: string;
  watch_id?: string;
  job_id?: string;
  alert_type: string;
...
export type JobDocumentDraft = {
  id: string;
  job_id: string;
  application_id?: string;
  source_resume_asset_id?: string;
  draft_type: "tailored_resume" | "cover_letter";
  title: string;
  content: string;
  status: string;
  generation_method: string;
  truth_basis?: Record<string, any>;
  warnings?: string[];
...
export type JobApplicationAssistance = {
  application?: Record<string, any>;
  job?: JobLead;
  drafts?: JobDocumentDraft[];
  readiness?: ApplicationReadinessCheck[];
